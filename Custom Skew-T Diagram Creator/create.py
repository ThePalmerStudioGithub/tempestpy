...
plt.legend(loc="best")
plt.grid(True)
plt.get_current_fig_manager().window.title(f"{name_of_diagram} - {date_of_diagram} @ {timestamp_of_diagram}z - Custom Skew-T Diagram Creator by Blaine Palmer (Ver {version})  || TempestPy {tempestpy_releasenameandversion} ")
